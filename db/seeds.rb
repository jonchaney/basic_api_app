...
# orders created at a later date for testing
# jon = User.find_by(first_name: "Jon")
# swayed = User.find_by(first_name: "Swayed")

# jon_order3 = Order.create(user_id: jon.id)
# swayed_order2 = Order.create(user_id: swayed.id)

# jon_order3.products << Product.find_by(name: "Fender Jazzmaster")
# jon_order3.products << Product.find_by(name: "CV/Gate Cable")
# swayed_order2.products << Product.find_by(name: "Steinway Piano Model D")
# swayed_order2.products << Product.find_by(name: "Sennheiser MD421 II")